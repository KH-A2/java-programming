	...
	<section class="container-fluid">
		...
		<form class="large-form" action="${updateUrl}" method="post" enctype="multipart/form-data">
				...
				<div class="col">
					<div class="form-floating mb-3">
						<input class="form-control" type="text" id="id_empId" name="empId"
							placeholder="ID" value="${sessionScope.loginData.empId}" disabled>
				...
				<div class="col">
					<div class="col form-floating mb-3">
						<input class="form-control" type="text" id="id_empName" name="empName"
							placeholder="이름" value="${sessionScope.loginData.empName}" disabled>
			...
			<div class="row g-3">
				<div class="col">
					<div class="form-floating mb-3">
						<select class="form-select" id="id_jobId" name="jobId" disabled>
				...
				<div class="col">
					<div class="form-floating mb-3">
						<select class="form-select" id="id_deptId" name="deptId" disabled>
				...
				<div class="col">
					<div class="form-floating mb-3">
						<input class="form-control" type="text" id="id_email" name="email"
							placeholder="이메일" value="${sessionScope.loginData.email}">
			...
			<div class="row g-3">
				<div class="col">
					<div class="form-floating mb-3">
						...
						<input class="form-control" type="text" id="id_hireDate" name="hireDate"
							placeholder="입사일" value="${fmtHireDate}" disabled>
				...
				<div class="col">
					<div class="form-floating mb-3">
						<input class="form-control" type="text" id="id_phone" name="phone"
							placeholder="전화번호" value="${empDetail.phone}">
			...
			<div class="row g-3">
				<div class="col">
					<div class="form-floating mb-3">
						...
						<input class="form-control" type="text" id="id_salary" name="salery"
							placeholder="급여액" value="${fmtSalary}" disabled>
				...
				<div class="col">
					<div class="form-floating mb-3">
						...
						<input class="form-control" type="text" id="id_commission" name="commission"
							placeholder="커미션" value="${fmtcommission}" disabled>
